                         ...
                         <form @submit.prevent="storeCustomers">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" id="price" name="birthday" v-model="form.birthday" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                                <div class="p-2 w-full">
                                <div class="relative">
                                    <label class="leading-7 text-sm text-gray-600 mr-4">性別</label>
                                    <input type="radio" id="gender1" name="gender0" v-model="form.gender" value="0">
                                    ...
                                    <input type="radio" id="gender2" name="gender2" v-model="form.gender" value="2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="memo" name="memo" v-model="form.memo" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out  whitespace-pre-wrap "></textarea>
                                </div>
                                </div>
